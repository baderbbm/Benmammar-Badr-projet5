...
class MedicalRecordServiceTest {
    ...
    void setUp() {
        ...
        MedicalRecord johnRecord = new MedicalRecord("John", "Boyd", johnBirthdate, List.of("aznol:350mg", "hydrapermazol:100mg"), List.of("nillacilan"));
        LocalDate jacobBirthdate = LocalDate.of(1989, 3, 6);
        MedicalRecord jacobRecord = new MedicalRecord("Jacob", "Boyd", jacobBirthdate, List.of("pharmacol:5000mg", "terazine:10mg", "noznazol:250mg"), List.of());
    ...
    void addMedicalRecord_shouldAddMedicalRecordToList() {
        ...
        MedicalRecord newMedicalRecord = new MedicalRecord("Tenley", "Boyd", tenleyBirthdate, List.of(), List.of("peanut"));
...
LocalDate johnBirthdate = LocalDate.of(1984, 3, 6);
MedicalRecord updatedMedicalRecord = new MedicalRecord("John", "Boyd", johnBirthdate, List.of("updated_med:500mg"), List.of("updated_allergy"));
    ...
    void deleteMedicalRecord_shouldRemoveMedicalRecordFromList() {
        ...
        assertFalse(medicalRecordService.getMedicalRecords().stream().anyMatch(record -> record.getFirstName().equals(firstName) && record.getLastName().equals(lastName)));
    }
